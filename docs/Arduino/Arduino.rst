...
|image1|\ 两个版本都可以正常使用，看你自己的喜好了。选择一个版本，然后将Arduino开发软件下载到我们的电脑。
...
Plus开发板，因为这个智能车的核心就是这个开发板。

.. image:: media/3a7d175f382a3614b0c8b4a183548757.png
...
它具有14个数字输入/输出引脚（其中6个可用作PWM输出），8个模拟输入，一个16
MHz石英晶体，一个USB连接，一个电源插孔，1个ICSP接头和一个复位按钮。
...
.. image:: media/066c14cb9ce6d82ee2003caecb39709d.png

如果驱动安装不成功，或者你想手动安装驱动，请打开电脑的设备管理器\ |image2|
...
.. image:: media/fcd004d8fe08d18457f343be56f8d81f.png

我们选择这个文件夹，然后点击确定，驱动安装成功。

.. image:: media/0d7f7488e7923489298c450299c79cba.png

这个时候再打开设备管理器，我就可以看到CP2102的驱动程序已经安装成功了，刚刚的那个黄色的感叹号不见了。

|image3|\ （4）Arduino IDE设置和工具栏介绍
...
.. image:: media/9ac8c365cd708c4567fd31c096a07422.png
...
.. image:: media/9ebff095e876a4ef97c1803756701c99.png

(2)开发板连接好电脑，选择好开发板和串口，点击上传程序，程序上传成功后舵机自动转到90度的位置

.. image:: media/42a8a798cdb305fcc430dad0182812e7.png
...
.. image:: media/f743957ae686118accdb69d181f8f272.png
...
.. image:: media/c4e8d7bfb95d08bd6bf121f8f8830301.png
...
.. image:: media/ebfc39b179ba70727ddf81ce6817deb5.png
...
+-----------------+-----------------+-----------------+-----------------+
| |image43|       | |image44|       | |image45|       | |image46|       |
+-----------------+-----------------+-----------------+-----------------+
...
.. image:: media/b364f075c393bf973139add3c662caf3.png
...
.. image:: media/7a1e0d244a83bad6564a24a50be11c08.jpg

红外遥控在日常生活中随处可见，它被用来控制各种家电，如电视、音响、录影机和卫星信号接收器。红外遥控是由红外发射和红外接收系统组成的，也就是一个红外遥控器和红外接收模块和一个能解码的单片机组成的。 

.. image:: media/7fa7afed8ee1fd21cde53a831e8bf7f2.png
...
.. image:: media/609ed7a4c425d8c4751f95d36251a47a.png
...
.. image:: media/3920253c86188ac64cf9b82c0df6c941.png
...
6.EN/BRK：断开连接，表示断开蓝牙连接，一般情况下，保持断开连接。\ |image65|
...
1. 扫码下载\ |image66|\ 或者进入APP下载链接：http://8.210.52.206/Turtle_Car.apk
...
3.REV4板上传代码成功后，连接蓝牙，上电后，蓝牙模块上LED闪烁。点击APP\ |image67|\ 图标，搜索到蓝牙，显示如下图。
...
5.点击桌面小车的\ |image68|\ 图片按钮，进入控制桌面小车的界面
...
上面的项目，我们讲解了蓝牙接收到手机发送的信号并且在开发板的串口显示出来，比如我们按下\ |image69|\ ，然后我们就会接收到‘B’，当我们松开的时候又接收到‘S’。那接下来我们就要想一下了，我们可以利用接收到的信号去做一些事情吗，答案是肯定的，我们这里就利用手机发送的命令去打开或者关闭一个LED灯。看接线图，在D9脚接了一个LED。

.. image:: media/99762080fdd2494984f803d81d6fafa7.png
...
上传代码完成后，点击手机APP
上\ |image70|\ 以控制LED。当您按下发送``B’‘时，LED将打开，而当您松开发送``S’’时，LED将关闭。
...
.. image:: media/3672f4baeb83269d24bbcf1786336a04.jpg
...
.. image:: media/09ae6a37d36a084a1b8e4049e6f37429.png
...
8*8点阵屏介绍
LED点阵屏由LED发光二极管组成，通过控制LED亮灭来显示文字、图片、动画、视频等，被广泛应用于公共场合做信息展示，如广告屏、公告牌等。\ |image85|
...
点阵和驱动的原理都已经介绍完了，那点阵上显示的内容是怎么来的呢，有没有比较简便的方法？我们需要把一个图案转换成1组16个的16位数据，这里就需要用到一个取模软件,这个软件已放入资料文件夹中。使用时打开\ |image86|\ 图标，显示如下图。

.. image:: media/c8281eddce26ce57970d5f152aabe2a4.png

点击\ |image87|\ 这个图标新建图案，根据显示屏规格，设置宽度为8，高度为8，如下图。

.. image:: media/c7d11d37e84a69d5adc10897ad37e3a9.png

初始时发现格点不大，不方便设置，我们可以通过设置模拟动画，设置格点大小，点击如下图。

.. image:: media/3a9fefd037cc21880017193917340cdc.png

鼠标左键点击\ |image88|\ ，就可以一直放大格点了。

放大后，我们就可以通过用鼠标点击白色区域，设置显示图案了。

.. image:: media/f64731328767eb73e7d40ffbdb3640a1.png

设置时，鼠标点击（左右键都可以）白色格点，变为黑色；再点击黑色格点，变为白色。黑色代表该格点显示亮起，白色代表格点不显示。显示屏最多能设置8*8个点显示。设置笑脸显示如下图。

.. image:: media/c414ee1d8909378e4b16b21b1f6a0492.png

设置参数设置，选择其他选项，设置如下图。设置完成点击\ |image89|\ 。

.. image:: media/d24b1b5674a1ac003349621db4224f81.png

.. image:: media/bcde86cfdb50025245832b8f53b8a034.png
...
.. image:: media/9f479a1cdba645b1d98b401a690c2ccf.png
...
课程10 画地为牢小乌龟 http://www.keyes-robot.com \*/
...
+-----------------------+-----------------------+-----------------------+
| 中                    | 中                    | 左循迹                |
| 循迹传感器检测到黑线  | 循迹传感器检测到白线  | 传感器检测到黑线并且  |
|                       |                       | 右                    |
|                       |                       | 循迹传感器检测到白线  |
+-----------------------+-----------------------+-----------------------+
| 中                    | 左循迹                | 右旋转（PWM设为200）  |
...
.. image:: media/650eb0a4fcd347cd319e668a26dba65d.png
...
将驱动扩展板堆叠在UNO
Plus板上，上传好代码，按照接线图接线，将拨码开关拨至ON端后，智能车能够随着前方障碍物的移动而移动。
...
将驱动扩展板堆叠在UNO
Plus板上，上传好代码，按照课程三接线图接线，将拨码开关拨至ON端后，智能车能够自动避开障碍物行走。
...
+-----------------------+-----------------------+-----------------------+
| 按键：\ |image90|     | 键值：FF629D          | 状态：前进            |
+=======================+=======================+=======================+
| 按键：\ |image91|     | 键值：FFA857          | 状态：后退            |
+-----------------------+-----------------------+-----------------------+
| 按键：\ |image92|     | 键值：FF22DD          | 状态：左转            |
+-----------------------+-----------------------+-----------------------+
| 按键：\ |image93|     | 键值：FFC23D          | 状态：右转            |
+-----------------------+-----------------------+-----------------------+
| 按键：\ |image94|     | 键值：FF02FD          | 状态：停止            |
+-----------------------+-----------------------+-----------------------+
...
|                       | 能：进入蓝牙控制界面  |                       |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image97|        | 功能：断开蓝牙连接    |                       |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image98|        | 控制字                | 功能：按下，          |
|                       | 符：按下：F；松开：S  | 小车前进；松开就停止  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image99|        | 控制字                | 功能：按下，          |
|                       | 符：按下：B；松开：S  | 小车后退；松开就停止  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image100|       | 控制字                | 功能：按下，小        |
|                       | 符：按下：L；松开：S  | 车左旋转；松开就停止  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image101|       | 控制字                | 功能：按下，小        |
|                       | 符：按下：R；松开：S  | 车右旋转；松开就停止  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image102|       | 控制字符：            | 功能：小              |
|                       | 点击发送：S           | 车停止，停止所有功能  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image103|       | 控制字符：            | 功                    |
|                       |                       | 能：点击一下开启手机  |
...
按下\ |image110|\ 按钮，小车前进；按下\ |image111|\ 按钮，小车后退；按下\ |image112|\ 按钮，小车左旋转；按下\ |image113|\ 按钮，小车右旋转；点击\ |image114|\ 按钮，小车停止；点击一下\ |image115|\ 按钮，开启手机方向感应控制，再点击一下\ |image116|\ 按钮，退出方向感应控制。
...
将驱动扩展板堆叠在UNO
Plus板上，上传好代码，按照接线图接线，将拨码开关拨至ON端后，手机APP连接蓝牙成功后，我们就能用手机APP控制智能车运动了。我们可以通过按下对应按钮实现对应功能，通过停止钮来停止功能,点击\ |image117|\ 会退出APP。
...
|                       | 能：进入蓝牙控制界面  |                       |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image120|       | 功能：断开蓝牙连接    |                       |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image121|       | 控制字                | 功能：按下，          |
|                       | 符：按下：F；松开：S  | 小车前进；松开就停止  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image122|       | 控制字                | 功能：按下，          |
|                       | 符：按下：B；松开：S  | 小车后退；松开就停止  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image123|       | 控制字                | 功能：按下，小        |
|                       | 符：按下：L；松开：S  | 车左旋转；松开就停止  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image124|       | 控制字                | 功能：按下，小        |
|                       | 符：按下：R；松开：S  | 车右旋转；松开就停止  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image125|       | 控制字符：            | 功能：小              |
|                       | 点击发送：S           | 车停止，停止所有功能  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image126|       | 控制字符：            | 功                    |
|                       |                       | 能：点击一下开启手机  |
...
|                       |                       | 击\ |image130|\ 退出  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image131|       | 控制字符：            | 功能：开              |
|                       | 点击发送：Y           | 启超声波跟随功能，点  |
|                       |                       | 击\ |image132|\ 退出  |
+-----------------------+-----------------------+-----------------------+

.. |image1| image:: media/3de06358873b1f90b42e88ae36fb36a2.png
